	...
	<div id="section">
		...
		<tr>
			<td  align="center" style="padding-left: 30px;">
                <a href="GStockManager.action" ><font id = "ch1" color = "#6699FF">商品采购</font></a>
            </td>
            <td  align="center" style="padding-left: 30px;">
                <a href="BStockManager.action" ><font id = "ch2" color = "#000099">物料采购</font></a>
            </td>
		</tr>
		</table>
		<table width = 100% >
		<tr>
			<td>
				<form name="form1" method="post" action="BStockManager.action">
							<table  width = 100% border="0" cellspacing="0" cellpadding="0" background="Images/bootBg.jpg">
								<tr>
									<td  align="center"><select name="SearchRow"
										id="SearchRow">
											<option value="BStock_Name">名称</option>
											<option value="BStock_Type">种类</option>
