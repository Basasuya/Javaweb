	...
	<div id="section">
		...
		<tr>
			<td  align="center" style="padding-left: 30px;">
                <a href="GBuyManager.action" ><font id = "ch1" color = "#6699FF">商品售卖</font></a>
            </td>
            <td  align="center" style="padding-left: 30px;">
                <a href="BBuyManager.action" ><font id = "ch2" color = "#000099">物料回收</font></a>
            </td>
		</tr>
		</table>
		<table width = 100% >
		<tr>
						...
						<table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator  value="list">
								<tr align="center">						
									...
									${BBuy_Id}</td>
									<td bgcolor="#ADD8E6">${BBuy_Name}</td>
									<td bgcolor="#ADD8E6">${BBuy_Type}</td>
									<td bgcolor="#ADD8E6">${BBuy_Unit}</td>
									<td bgcolor="#ADD8E6">${BBuy_Num}</td>
									<td bgcolor="#ADD8E6">${BBuy_Pro}</td>
									<td bgcolor="#ADD8E6">${BBuy_Time}</td>
									<td width = 10px></td>
									<td align="center"  bgcolor="#0000FF"><a
										href="BBuyUpdate.action?BBuy_Id=${BBuy_Id}" 
										><font color="white">修改</font></a> <a
										href="BBuyDel.action?BBuy_Id=${BBuy_Id}"
			...
			<table align = center id = "bood2" >
				<tr>
					<td  height="30" style="padding-left:20px;" background="Images/mainMenuBg.jpg"><a href="BBuyAdd.jsp"><strong>添加回收信息</strong></a></td>
				</tr>
			</table>
	</div>
