	...
	<div id="section">
		...
		<tr>
			<td  align="center" style="padding-left: 30px;">
                <a href="GReturnManager.action" ><font id = "ch1" color = "#6699FF">商品退货</font></a>
            </td>
            <td  align="center" style="padding-left: 30px;">
                <a href="BReturnManager.action" ><font id = "ch2" color = "#000099">物料退货</font></a>
            </td>
		</tr>
		</table>
		<table width = 100% >
		<tr>
			<td>
				<form name="form1" method="post" action="BReturnManager.action">
							<table  width = 100% border="0" cellspacing="0" cellpadding="0" background="Images/bootBg.jpg">
								<tr>
									<td  align="center"><select name="SearchRow"
										id="SearchRow">
											<option value="BReturn_Name">名称</option>
											<option value="BReturn_Type">种类</option>
						...
						<table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator  value="list">
								<tr align="center">						
									...
									${BReturn_Id}</td>
									<td bgcolor="#ADD8E6">${BReturn_Name}</td>
									<td bgcolor="#ADD8E6">${BReturn_Type}</td>
									<td bgcolor="#ADD8E6">${BReturn_Unit}</td>
									<td bgcolor="#ADD8E6">${BReturn_Cost}</td>
									<td bgcolor="#ADD8E6">${BReturn_Num}</td>
									<td bgcolor="#ADD8E6">${BReturn_Pro}</td>
									<td bgcolor="#ADD8E6">${BReturn_Time}</td>
									<td width = 10px></td>
									<td align="center"  bgcolor="#0000FF"><a
										href="BReturnUpdate.action?BReturn_Id=${BReturn_Id}" 
										><font color="white">修改</font></a> <a
										href="BReturnDel.action?BReturn_Id=${BReturn_Id}"
			...
			<table align = center id = "bood2" >
				<tr>
					<td  height="30" style="padding-left:20px;" background="Images/mainMenuBg.jpg"><a href="BReturnAdd.jsp"><strong>添加退货信息</strong></a></td>
				</tr>
			</table>
	</div>
