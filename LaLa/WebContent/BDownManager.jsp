	...
	<div id="section">
		...
		<tr>
			<td  align="center" style="padding-left: 30px;">
                <a href="GDownManager.action" ><font id = "ch1" color = "#6699FF">商品下架</font></a>
            </td>
            <td  align="center" style="padding-left: 30px;">
                <a href="BDownManager.action" ><font id = "ch2" color = "#000099">物料下架</font></a>
            </td>
		</tr>
		</table>
		<table width = 100% >
		<tr>
			<td>
				<form name="form1" method="post" action="BDownManager.action">
							<table  width = 100% border="0" cellspacing="0" cellpadding="0" background="Images/bootBg.jpg">
								<tr>
									<td  align="center"><select name="SearchRow"
										id="SearchRow">
											<option value="BDown_Name">名称</option>
											<option value="BDown_Type">种类</option>
						...
						<table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator  value="list">
								<tr align="center">
									...
									${BDown_Id}</td>
									<td bgcolor="#ADD8E6">${BDown_Name}</td>
									<td bgcolor="#ADD8E6">${BDown_Type}</td>
									<td bgcolor="#ADD8E6">${BDown_Unit}</td>
									<td bgcolor="#ADD8E6">${BDown_Twarehouse}</td>
									<td bgcolor="#ADD8E6">${BDown_Tbar}</td>
									<td bgcolor="#ADD8E6">${BDown_Num}</td>
									<td bgcolor="#ADD8E6">${BDown_Time}</td>
									<td width = 10px></td>
									<td align="center"  bgcolor="#0000FF"><a
										href="BDownUpdate.action?BDown_Id=${BDown_Id}" 
										><font color="white">修改</font></a> <a
										href="BDownDel.action?BDown_Id=${BDown_Id}"
			...
			<table align = center id = "bood2" >
				<tr>
					<td  height="30" style="padding-left:20px;" background="Images/mainMenuBg.jpg"><a href="BDownAdd.jsp"><strong>添加下架信息</strong></a></td>
				</tr>
			</table>
	</div>
