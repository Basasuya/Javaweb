...
public class GoodsUpdateSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(list.size() > 0 && Goods_Name.equals(cnbean.getGoods_Name()) == false) {
	...
	//	System.out.println(Goods_Bar+" ");
		
		new GoodsDao().Update(cnbean);
		    
		//跳转
		out.print("<script language='javascript'>alert('修改成功！');window.location='GoodsManager.action';</script>");
		out.flush();out.close();return null;
