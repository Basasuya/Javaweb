	...
	<div id="section">
		...
		<tr>
			<td  align="center" style="padding-left: 30px;">
                <a href="GDownManager.action" ><font id = "ch1" color = "#000099">商品下架</font></a>
            </td>
            <td  align="center" style="padding-left: 30px;">
                <a href="BDownManager.action" ><font id = "ch2" color = "#6699FF">物料下架</font></a>
            </td>
		</tr>
		</table>
		<table width = 100% >
		<tr>
			<td>
				<form name="form1" method="post" action="GDownManager.action">
							<table  width = 100% border="0" cellspacing="0" cellpadding="0" background="Images/bootBg.jpg">
								<tr>
									<td  align="center"><select name="SearchRow"
										id="SearchRow">
											<option value="GDown_Name">名称</option>
											<option value="GDown_Type">种类</option>
		...
		<table width = 100% border="0" cellspacing="0" cellpadding="0" id = "good1">
						...
						<table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator  value="list">
								<tr align="center">
									...
									${GDown_Id}</td>
									<td bgcolor="#ADD8E6">${GDown_Name}</td>
									<td bgcolor="#ADD8E6">${GDown_Type}</td>
									<td bgcolor="#ADD8E6">${GDown_Unit}</td>
									<td bgcolor="#ADD8E6">${GDown_Twarehouse}</td>
									<td bgcolor="#ADD8E6">${GDown_Tbar}</td>
									<td bgcolor="#ADD8E6">${GDown_Num}</td>
									<td bgcolor="#ADD8E6">${GDown_Time}</td>
									<td width = 10px></td>
									<td align="center"  bgcolor="#0000FF"><a
										href="GDownUpdate.action?GDown_Id=${GDown_Id}" 
										><font color="white">修改</font></a> <a
										href="GDownDel.action?GDown_Id=${GDown_Id}"
			...
			<table align = center id = "good2">
				<tr>
					<td  height="30" style="padding-left:20px;" background="Images/mainMenuBg.jpg"><a href="GDownAdd.jsp"><strong>添加下架信息</strong></a></td>
				</tr>
			</table>
	</div>
