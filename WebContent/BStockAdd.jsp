	...
	<div id="section">
		...
		<table width=100% border="0" cellspacing="0" cellpadding="0"
			...
			<tr align="center" valign="center" >
				<td >
					<form name="form1" method="post" action="BStockAddSave.action">
						<table height = "70%" width="70%" border="0" cellspacing="0" cellpadding="0" >
							...
							<tr align="center">
								<td><font color="blue">单价：</font><input name="BStock_Cost" type="text" class="text2"
									id="BStock_Cost"></td>
							</tr>
							<tr align="center">
								<td><font color="blue">采购数量：</font><input name="BStock_Num" type="text" class="text2"
									id="BStock_Num"></td>
							</tr>
							<tr align="center">
