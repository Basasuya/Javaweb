...
<center>
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="0" >
    <tr>
      <td height="280" align="center" valign="top" bgcolor="#F0F8FF" >
      <table width="350" height="201" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="72" align="center" style="background-color:#000000;"><font color="white"><h2>杰拉网咖进销存管理系统</h2></font></td>
        </tr>
        <tr>
          <td align="center" valign="top">
             <form name="form1" action="AdminGo.action" method="post" onSubmit="return mycheck()">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="37%" height="30" align="right" class="STYLE2"><strong>用户名：</strong></td>
                  <td width="300" align="left"><input type="text" name="Username" id="Username" class="text1" /></td>
                  </tr>
                <tr>
                  <td height="30" align="right" class="STYLE2"><strong>密码：</strong></td>
