	...
	<div id="section">
		...
		<tr>
			<td  align="center" style="padding-left: 30px;">
                <a href="GBuyManager.action" ><font id = "ch1" color = "#000099">商品售卖</font></a>
            </td>
            <td  align="center" style="padding-left: 30px;">
                <a href="BBuyManager.action" ><font id = "ch2" color = "#6699FF">物料回收</font></a>
            </td>
		</tr>
		</table>
		<table width = 100% >
		...
		<table width = 100% border="0" cellspacing="0" cellpadding="0" id = "good1">
						...
						<table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
							...
							<s:iterator  value="list">
								<tr align="center">
									...
									${GBuy_Id}</td>
									<td bgcolor="#ADD8E6">${GBuy_Name}</td>
									<td bgcolor="#ADD8E6">${GBuy_Type}</td>
									<td bgcolor="#ADD8E6">${GBuy_Unit}</td>
									<td bgcolor="#ADD8E6">${GBuy_Num}</td>
									<td bgcolor="#ADD8E6">${GBuy_Pro}</td>
									<td bgcolor="#ADD8E6">${GBuy_Time}</td>
									<td width = 10px></td>
									<td align="center"  bgcolor="#0000FF"><a
										href="GBuyUpdate.action?GBuy_Id=${GBuy_Id}" 
										><font color="white">修改</font></a> <a
										href="GBuyDel.action?GBuy_Id=${GBuy_Id}"
			...
			<table align = center id = "good2">
				<tr>
					<td  height="30" style="padding-left:20px;" background="Images/mainMenuBg.jpg"><a href="GBuyAdd.jsp"><strong>添加售卖信息</strong></a></td>
				</tr>
			</table>
	</div>
